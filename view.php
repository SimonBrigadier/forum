...
/// Print settings and things across the top
    ...
    /*
     * ПСТГУ PSTGU вывод сообщения для контрольного форума
     *       
     */
    
    if ($forum->type == 'mod_forum_pstgu' && !has_capability('moodle/course:manageactivities', $context)) {
        echo $OUTPUT->notification(get_string('modforumpstgunotify','forum'));
    }
    switch ($forum->type) {
        case 'single':
